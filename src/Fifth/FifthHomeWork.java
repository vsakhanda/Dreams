...
// Другий метод аналізу без використання else
    public static void parity2(int q) {
        System.out.println("Початок перевірки на парність");
        if (q%2 == 0) {
            System.out.println(q + "Число парне. Завершення аналізу");
        }
        System.out.println("Число не парнею Завершення аналізу");
    }
    ...
    public static void parityScanner()
    {
        ...
        Integer q = Integer.valueOf(parityScanner.next());
